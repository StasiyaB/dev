...
var phrase = phrases[0].length;
var phraseLength, longest;
...
for (var i=1;  i < phrases.length; i++) {
    ...
    /*document.write('<p>'+phrases.length+'</p>');
    break;*/ 

    console.log(phrases[i].length);
        if (phrases[longest].length < phrases[i].length ){
...
document.write('la plus longue : '+ phrases[longest])
